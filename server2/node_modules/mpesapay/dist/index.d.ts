declare class MpesaPay {
    ...
    constructor(consumerKey: string, consumerSecret: string, businessShortCode: string, passkey: string, accountReference: string, transactionDesc: string, partyA: string, b2cSecurityCredential: string, initiatorName: string, environment?: 'sandbox' | 'live', transactionType?: 'paybill' | 'till');
