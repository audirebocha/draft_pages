...
__export(src_exports, {
  ...
  FormatBusinessToCustomer: () => FormatBusinessToCustomer,
  FormatPaymentData: () => FormatPaymentData,
  MpesaPay: () => mpesapay_default,
  default: () => src_default,
  generateUniqueReferenceNumber: () => generateUniqueReferenceNumber
});
...
function generateAccessToken(consumerKey, consumerSecret, environment) {
  return __async(this, null, function* () {
    ...
    try {
      const response = yield import_axios.default.get(
...
function initMpesaExpressRequestBody(amount, phoneNumber, callbackUrl, timeStamp2, password, businessShortCode, accountReference, transactionDesc, transactionType) {
...
// src/transactions/mpesaexpress/index.ts
function MpesaExpress(amount, phoneNumber, callbackUrl, businessShortCode, passkey, accessToken, environment, accountReference, transactionDesc, transactionType) {
  return __async(this, null, function* () {
...
function checkTransactionStatus(transactionId, callbackUrl, initiator, accessToken, b2cSecurityCredential, partyA, environment) {
  return __async(this, null, function* () {
    ...
    try {
      const response = yield import_axios4.default.post(
...
function getAccountBalance(partyA, callbackUrl, initiatorName, b2cSecurityCredential, accessToken, environment) {
  return __async(this, null, function* () {
    ...
    try {
      const response = yield import_axios5.default.post(
...
// src/transactions/stkpushQuery/index.ts
var import_axios6 = __toESM(require("axios"), 1);

// src/transactions/stkpushQuery/stkPushQueryBody.ts
function initStkPushQueryRequestBody(businessShortCode, password, timeStamp2, CheckoutRequestID) {
  return {
    BusinessShortCode: businessShortCode,
    Password: password,
    Timestamp: timeStamp2,
...
// src/transactions/stkpushQuery/index.ts
function StkPushQuery(businessShortCode, passkey, accessToken, environment, CheckoutRequestID) {
  return __async(this, null, function* () {
    const password = generatePassword(businessShortCode, passkey);
    ...
    try {
      const response = yield import_axios6.default.post(
...
var MpesaPay = class {
  constructor(consumerKey, consumerSecret, businessShortCode, passkey, accountReference, transactionDesc, partyA, b2cSecurityCredential, initiatorName, environment = "sandbox", transactionType = "paybill") {
    ...
    this.environment = environment === "live" ? "https://api.safaricom.co.ke" : "https://sandbox.safaricom.co.ke";
