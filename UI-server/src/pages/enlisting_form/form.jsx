                            ...
                            <div className="enlist_question_container_lvl1">
                                ...
                                <div className="enlist_options_container_lvl1">
                                    <div className="enlist_options_container_lvl2">
                                        <input type="radio" value="Entire Place" onChange={onSubletChange} checked={sublet === 'Entire Place'}/>
                                    ...
                                    <div className="enlist_options_container_lvl2">
                                        <input type="radio" value="Shared bedroom" onChange={onSubletChange} checked={sublet === 'Shared bedroom'}/>
